...
public class SnowflakeDialect extends Dialect {
    ...
    static final String CONFIGURATION_PROPERTY_TABLE_TYPE = CONFIGURATION_PROPERTY_PREFIX + "table_type";
    static final String CONFIGURATION_PROPERTY_DEVELOPMENT_MODE = CONFIGURATION_PROPERTY_PREFIX + "development_mode";
    static final String ALLOW_UNRECOMMENDED_JDBC_DRIVER_VERSION = CONFIGURATION_PROPERTY_PREFIX + "allow_unrecommended_jdbc_driver";
    ...
    public SnowflakeDialect(DialectResolutionInfo info) {
        ...
        tableType = TableType.valueOf(
                (String) configurationValues.getOrDefault(
    ...
    private void warnOnUnsupportedDriverVersion(Map<String, Object> configurationValues) {
        ...
        try {
            boolean allowUnrecommendedJdbcDriver = Boolean.parseBoolean(
                    (String) configurationValues.getOrDefault(
